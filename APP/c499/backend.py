...
def upload_report(user_id,description,longitude,latitude,plates,name,badge,profile,filenames):
    """
    ...
    incident=IncidentReport(user_id=user_id,description=description,longitude=longitude,latitude=latitude,plates=plates,name=name,badge=badge,profile=profile,date_time=datetime.now(),filenames=filenames)
